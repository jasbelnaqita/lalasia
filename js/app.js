(() => {
    ...
    function initSliders() {
        const ourSlider = document.querySelector(".our__slider");
        if (ourSlider) new swiper_core_Swiper(ourSlider, {
            modules: [ Navigation ],
            centeredSlides: true,
            ...
            loop: true,
            navigation: {
                prevEl: ".our__arrow--left",
                nextEl: ".our__arrow--right"
            },
            breakpoints: {
                768: {
                    slidesPerView: 2,
        ...
        if (testimonialsSlider) new swiper_core_Swiper(testimonialsSlider, {
            modules: [ Navigation ],
            centeredSlides: true,
            centeredSlidesBounds: true,
            speed: 800,
        ...
        if (articlesSlider) new swiper_core_Swiper(articlesSlider, {
            modules: [ Navigation ],
            centeredSlides: true,
            centeredSlidesBounds: false,
            slidesPerView: 1,
        ...
        const productsSlider = document.querySelector(".hero-slider");
        if (productsSlider) new swiper_core_Swiper(productsSlider, {
            modules: [ Navigation ],
            slidesPerView: 1,
            slidesPerGroup: 1,
            spaceBetween: 15,
            ...
            loop: true,
            navigation: {
                prevEl: ".hero-slider--products-left",
                nextEl: ".hero-slider--products-right"
            },
            on: {}
        });
        const articleSlider = document.querySelector(".article__slider");
        if (articleSlider) new swiper_core_Swiper(articleSlider, {
            ...
            navigation: {
                prevEl: ".article-slider--products-left",
                nextEl: ".article-slider--products-right"
            },
            on: {}
        });
    }
    ...
    class parallax_Parallax {
        constructor(elements) {
            this.elements = [];
            if (elements.length) this.elements = Array.from(elements).map((el => new parallax_Parallax.Each(el)));
        }
        destroyEvents() {
            this.elements.forEach((el => el.destroyEvents()));
        }
        setEvents() {
            this.elements.forEach((el => el.setEvents()));
        }
    }
    parallax_Parallax.Each = class {
        ...
        animationFrame() {
            ...
            if (this.baseTop === null) this.baseTop = rect.top;
            const isVisible = rect.bottom >= 0 && rect.top <= heightWindow;
            if (isVisible) this.offset = this.baseTop - rect.top;
            this.value += (this.offset - this.value) / this.smooth;
            this.animationID = window.requestAnimationFrame(this.animation);
            this.elements.forEach((el => {
                const parameters = {
                    axis: el.dataset.axis ? el.dataset.axis : "v",
                    direction: el.dataset.direction ? Number(el.dataset.direction) : -1,
                    coefficient: el.dataset.coefficient ? Number(el.dataset.coefficient) : 5,
                    additionalProperties: el.dataset.properties ? el.dataset.properties : ""
                };
                this.applyTransform(el, parameters);
            }));
        }
        applyTransform(el, parameters) {
            const move = (parameters.direction * (this.value / parameters.coefficient)).toFixed(2);
            if (parameters.axis === "v") el.style.transform = `translate3D(0, ${move}px, 0) ${parameters.additionalProperties}`; else if (parameters.axis === "h") el.style.transform = `translate3D(${move}px, 0, 0) ${parameters.additionalProperties}`;
        }
    };
    const parents = document.querySelectorAll("[data-prlx-parent]");
    if (parents.length) modules_flsModules.parallax = new parallax_Parallax(parents);
    ...
    const video = document.querySelector(".about-hero__video");
    if (video) {
        const playBtn = document.querySelector(".about-hero__play");
        const togglePlay = () => {
            if (video.paused) {
                video.play();
    ...
    const readMore_text = document.querySelector(".item__text.text--description");
    const readMoreBtn = document.querySelector(".item__read-more");
    if (readMoreBtn && readMore_text) readMoreBtn.addEventListener("click", (() => {
        if (readMoreBtn.textContent === "Read More") {
            readMore_text.classList.add("text-visible");
            readMoreBtn.textContent = "Read Less";
        } else {
            readMore_text.classList.remove("text-visible");
    ...
    const PRODUCTS = [ {
        ...
        price: 99.98,
        description: "Faucibus facilisi morbi pharetra quis sed. Vitae suspendisse facilisis facilisis ligula felis et a parturient aenean. Ac maecenas ultricies felis risus scelerisque duis posuere...",
        images: [ "img/product-page/chairBlack.webp", "img/product-page/chairGreen.webp", "img/product-page/chairYellow.webp", "img/product-page/chairWhite.webp" ]
    }, {
        id: "2",
        ...
        price: 79.88,
        description: "Faucibus facilisi morbi pharetra quis sed. Vitae suspendisse facilisis facilisis ligula felis et a parturient aenean. Ac maecenas ultricies felis risus scelerisque duis posuere...",
        images: [ "img/product-page/cupboardBlack.webp", "img/product-page/cupboardGreen.webp", "img/product-page/cupboardYellow.webp", "img/product-page/cupboardWhite.webp" ]
    }, {
        id: "3",
        title: "Minimalist Lounge Lamp",
        subtitle: "Combination of wood and wool",
        price: 14.74,
        description: "Faucibus facilisi morbi pharetra quis sed. Vitae suspendisse facilisis facilisis ligula felis et a parturient aenean. Ac maecenas ultricies felis risus scelerisque duis posuere...",
        images: [ "img/product-page/lampBlack.webp", "img/product-page/lampGreen.webp", "img/product-page/lampYellow.webp", "img/product-page/lampWhite.webp" ]
    }, {
        id: "4",
        ...
        price: 47.9,
        description: "Faucibus facilisi morbi pharetra quis sed. Vitae suspendisse facilisis facilisis ligula felis et a parturient aenean. Ac maecenas ultricies felis risus scelerisque duis posuere...",
        images: [ "img/product-page/deskBlack.webp", "img/product-page/deskGreen.webp", "img/product-page/deskYellow.webp", "img/product-page/deskWhite.webp" ]
    }, {
        id: "5",
        title: "Minimalist Cupboard",
        subtitle: "Combination of wood and wool",
        price: 40.73,
        description: "Faucibus facilisi morbi pharetra quis sed. Vitae suspendisse facilisis facilisis ligula felis et a parturient aenean. Ac maecenas ultricies felis risus scelerisque duis posuere...",
        images: [ "img/product-page/minimalistCupboardBlack.webp", "img/product-page/minimalistCupboardGreen.webp", "img/product-page/minimalistCupboardYellow.webp", "img/product-page/minimalistCupboardWhite.webp" ]
    }, {
        id: "6",
        ...
        price: 160.5,
        description: "Faucibus facilisi morbi pharetra quis sed. Vitae suspendisse facilisis facilisis ligula felis et a parturient aenean. Ac maecenas ultricies felis risus scelerisque duis posuere...",
        images: [ "img/product-page/tableBlack.webp", "img/product-page/tableGreen.webp", "img/product-page/tableYellow.webp", "img/product-page/tableWhite.webp" ]
    }, {
        id: "7",
        ...
        price: 58.39,
        description: "Faucibus facilisi morbi pharetra quis sed. Vitae suspendisse facilisis facilisis ligula felis et a parturient aenean. Ac maecenas ultricies felis risus scelerisque duis posuere...",
        images: [ "img/product-page/vaseBlack.webp", "img/product-page/vaseGreen.webp", "img/product-page/vaseYellow.webp", "img/product-page/vaseWhite.webp" ]
    }, {
        id: "8",
        ...
        price: 61.49,
        description: "Faucibus facilisi morbi pharetra quis sed. Vitae suspendisse facilisis facilisis ligula felis et a parturient aenean. Ac maecenas ultricies felis risus scelerisque duis posuere...",
        images: [ "img/product-page/clayBlack.webp", "img/product-page/clayGreen.webp", "img/product-page/clayYellow.webp", "img/product-page/clayWhite.webp" ]
    }, {
        id: "9",
        ...
        price: 32.43,
        description: "Faucibus facilisi morbi pharetra quis sed. Vitae suspendisse facilisis facilisis ligula felis et a parturient aenean. Ac maecenas ultricies felis risus scelerisque duis posuere...",
        images: [ "img/product-page/mirrorBlack.webp", "img/product-page/mirrorGreen.webp", "img/product-page/mirrorYellow.webp", "img/product-page/mirrorWhite.webp" ]
    } ];
    (() => {
        ...
        const subtitleEl = document.querySelector(".js-product-subtitle");
        ...
        if (images.length && product.images?.length) images.forEach(((imgEl, i) => {
            if (product.images[i]) {
    ...
    links.forEach((link => {
        ...
        if (href === currentPage || href === "index.html" && currentPage === "" || href.includes("product") && currentPage.includes("product")) link.classList.add("active");
        if (href.includes("article") && currentPage.includes("article")) link.classList.add("active");
    }));
})();